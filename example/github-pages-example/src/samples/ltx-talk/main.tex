...
%% Adapted from https://www.texdev.net/ltx-talk/examples/ (math-fonts example by Joseph Wright, LPPL 1.3c)
...
\end{frame}
\begin{frame}
  \frametitle{Parabola Visualisation}
  \centering
  \includegraphics[height=0.5\textheight]{parabola.pdf}
\end{frame}
\end{document}